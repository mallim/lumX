...
angular.module("lumx.dropdown").run(['$templateCache', function(a) { a.put('', '<div ng-transclude="1"></div>\n' +
    '');
    ...
    '</div>\n' +
    '');
	a.put('', '<div class="dropdown" ng-transclude="parent"></div>\n' +
    '');
	 }]);
...
angular.module("lumx.text-field").run(['$templateCache', function(a) { a.put('', '<div class="text-field"\n' +
...
angular.module("lumx.search-filter").run(['$templateCache', function(a) { a.put('', '<div class="search-filter" ng-class="{ \'search-filter--is-focused\': model }">\n' +
...
angular.module("lumx.select").run(['$templateCache', function(a) { a.put('', '<div lx-dropdown-toggle>\n' +
...
angular.module("lumx.date-picker").run(['$templateCache', function(a) { a.put('', '<div class="lx-date">\n' +
